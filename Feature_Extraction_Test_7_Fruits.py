...
#164+166+166+166+166+164+164=1156
dataset_features = numpy.zeros(shape=(1156, 360))
outputs = numpy.zeros(shape=(1156))
...
with open("Datasets/test_set_features_optional.pkl", "wb") as f:
    pickle.dump(dataset_features, f)

with open("Datasets/test_set_labels_optional.pkl", "wb") as f:
